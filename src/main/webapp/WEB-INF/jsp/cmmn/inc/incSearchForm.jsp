...
<input type="hidden" name="selectRepliedBoard" id="selectRepliedBoard" value="<c:out value='${searchVO.selectRepliedBoard}'/>"/>
<input type="hidden" name="selectNoticeDateCat" id="selectNoticeDateCat" value="<c:out value='${searchVO.selectNoticeDateCat}'/>"/>
