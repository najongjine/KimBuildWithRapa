...
<div class="content_box">
	...
	<ul class="tab js-tab tab_menu">
	    ...
	    <li class="current"><a href="javascript:void(0)" onclick="searchLog(4); return false;">로그인 이상관리</a></li>
	</ul>
		...
		<form:form commandName="searchVO" name="defaultFrm" id="defaultFrm" method="post"  onsubmit="return false;">
			...
			<fieldset>
				...
				<div id="searchDefault" class="search_basic">
					...
					<input type="number" name="schEtc04" id="schEtc04" class="text w12p" />
					<div>
						...
						<span class="calendar_input w150 hideBtn2" >
							<input id="schEtc02" name="schEtc02" class="text w80p" type="time" value="----"/>
						</span>
						<span class="input_wave hideBtn2">~</span>
						<span class="calendar_input w150 hideBtn2" >
							<input id="schEtc03" name="schEtc03" class="text w80p" type="time" value="----"/>
