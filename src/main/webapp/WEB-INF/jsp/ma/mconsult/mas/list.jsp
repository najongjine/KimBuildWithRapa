		...
		<form:form commandName="searchVO" name="defaultFrm" id="defaultFrm" method="post"  onsubmit="return false;">
			...
			<fieldset>
				...
				<div class="search_basic">
					...
					<span>
						<strong class="">&nbsp;&nbsp;처리상태 : </strong>
						<form:select path="selectRepliedBoard" id="selectRepliedBoard" title="답변여부 선택" cssClass="w100"  >  
							<form:option value="0" label="전체"/>
							<form:option value="1" label="답변완료"/>
							<form:option value="-1" label="미완료"/>
						</form:select>
					</span>
