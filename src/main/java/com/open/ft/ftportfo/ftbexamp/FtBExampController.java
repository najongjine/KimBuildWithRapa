package com.open.ft.ftportfo.ftbexamp;
 ...
 */
@Controller
public class FtBExampController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BExamp";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftbexamp/";
	...
	public String proc(@ModelAttribute("searchVO") BImgVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
		...
		String userSeq=(String) session.getAttribute("loginFtSeq");
		userSeq=StringUtil.nullString(userSeq);
		if(procType != null){
			...
			if (procType.equals("insert")) {
				...
				BImgVO boardVO=(BImgVO) cmmnService.selectContents(searchVO, PROGRAM_ID);
				if(!userSeq.equals(boardVO.getRgstId())) {
