...
public class MSiteManageController {
	...
	public String view(@ModelAttribute("searchVO") FormInputVO searchVO, Model model, HttpServletRequest request) throws Exception {
		
		/* 게시판 상세정보 */
		FormInputVO sampleVO = new FormInputVO();
		sampleVO = (FormInputVO) cmmnService.selectContents(searchVO, PROGRAM_ID );
	...
	public String form(@ModelAttribute("searchVO") FormInputVO searchVO, Model model,@PathVariable String procType, HttpServletRequest request) throws Exception {
	...
	public String proc(@ModelAttribute("searchVO") FormInputVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
		
		System.out.println("## getImageFile : "+searchVO.getImageFile().toString());
		System.out.println("## color : "+searchVO.getColor().toString());
		System.out.println("## time : "+searchVO.getTime().toString());
		System.out.println("## datetime : "+searchVO.getDatetime().toString());
		System.out.println("## month : "+searchVO.getMonth().toString());
		System.out.println("## week : "+searchVO.getWeek().toString());
		if(procType != null){
