...
public class CmmnDefaultVO implements Serializable {
	...
	private String selectRepliedBoard="0";
	private String selectNoticeDateCat="rgstdate";
	...
	public String getSelectRepliedBoard() {
		return selectRepliedBoard;
	}

	public void setSelectRepliedBoard(String selectRepliedBoard) {
		this.selectRepliedBoard = selectRepliedBoard;
	}

	public String getSelectNoticeDateCat() {
		return selectNoticeDateCat;
	}

	public void setSelectNoticeDateCat(String selectNoticeDateCat) {
		this.selectNoticeDateCat = selectNoticeDateCat;
	}
